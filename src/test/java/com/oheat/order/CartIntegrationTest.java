...
public class CartIntegrationTest {
    ...
    void givenSameCartItem_whenAddToCart_thenIncreaseAmount() {
        ...
        CartOptionGroupOption cartOptionGroupOption1 = CartOptionGroupOption.builder()
            ...
            .option(option1)
            .build();
        cartOptionGroup1.addOption(cartOptionGroupOption1);
        cart.addOptionGroup(cartOptionGroup1);
        ...
        CartOptionGroupOption cartOptionGroupOption3 = CartOptionGroupOption.builder()
            ...
            .option(option3)
            .build();
        cartOptionGroup2.addOption(cartOptionGroupOption2);
        cartOptionGroup2.addOption(cartOptionGroupOption3);
        cart.addOptionGroup(cartOptionGroup2);
